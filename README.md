...
1. Скачай бандл со звуком по ссылке в описании последнего [релиза](../../releases/latest) (Google Drive) — там код + установщик + ассеты.
...
> Бандл содержит ассеты Warcraft III (© Blizzard) — только для личного некоммерческого использования, см. дисклеймер. В самом репозитории этих ассетов нет.
