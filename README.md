...
1. Скачай **`slave-full-bundle.zip`** из [Releases](../../releases/latest) — там код + установщик + ассеты.
...
> Бандл содержит ассеты Warcraft III (© Blizzard) — только для личного некоммерческого использования, см. дисклеймер.
